...
>
  <head>
    ...
    <title>Dashboard - Analytics | E-Booking</title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">E-Booking</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ request()->is('service-provider/home') ? 'active' : '' }}">
                <a href="{{ route('service-providers-home') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('service-provider/services/list') || request()->is('service-provider/services/create') ? 'active' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                    <div data-i18n="roles">Services</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->is('service-provider/services/list') ? 'active' : '' }}">
                    <a href="{{ route('services-list') }}" class="menu-link">
                        <div data-i18n="all_roles">List</div>
                    </a>
                    </li>
                    <li class="menu-item {{ request()->is('service-provider/services/create') ? 'active' : '' }}">
                    <a href="{{ route('services-create') }}" class="menu-link">
                        <div data-i18n="create_role">Add New</div>
                    </a>
                    </li>
                </ul>
            </li>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('service-providers-logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                        <i class="bx bx-power-off me-2"></i>
                        <span class="align-middle">Log Out</span>
                        <form id="logout-form" action="{{ route('service-providers-logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                      </a>
                    </li>
