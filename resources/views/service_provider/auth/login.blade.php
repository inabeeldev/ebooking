...
>
  <head>
    ...
    <title>Service Provider Login | E-Booking</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              @if(session('success'))
                ...
                @endif
              <h3 class="mb-4 text-center">Servie Provider <br>Sign In</h3>

              <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('service-providers-login-post') }}">
                @csrf
                <div class="mb-3">
              ...
              <p class="text-center">
                ...
                <a href="{{ route('service-providers-register') }}">
