      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->is('admin/service-providers/list') || request()->is('admin/service-providers/create') ? 'active' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                    <div data-i18n="users">Service Providers</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->is('admin/service-providers/list') ? 'active' : '' }}">
                    <a href="{{ route('service-providers-list') }}" class="menu-link">
                        <div data-i18n="list">List</div>
                    </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/service-providers/create') ? 'active' : '' }}">
                    <a href="{{ route('service-providers-create') }}" class="menu-link">
                        <div data-i18n="create">Create New</div>
                    </a>
                    </li>
                </ul>
            </li>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  <a href="{{ '/' }}" target="_blank" class="footer-link fw-bolder">Afshan & Muqadas</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
